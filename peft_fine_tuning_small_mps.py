...
squad_train = squad['train'].select(range(10))
...
trainer_config = SFTConfig(
    ...
    logging_steps=1,
    seed=42,
    save_steps=10, # Save after 50
    save_total_limit=2, #Only 2 newest checkpoints
)
...
trainer.train(resume_from_checkpoint="outputs/checkpoint-40")